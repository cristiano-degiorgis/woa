...
<div>
	<asp:Label ID="lblNoItem" Runat="server" Visible="False">No sono stati ancora inseriti trattamenti per questo consulto</asp:Label></div>
...
<asp:DataGrid id="dg1" Width="500" HeaderStyle-CssClass="trHeader" AutoGenerateColumns="false" DataKeyField="ID" OnItemCommand="Item_Command" Runat="server">
	...
	<div class="contextLink">
		<asp:HyperLink id="hlAdd" Runat="server" >&gt;&gt; Inserisci Trattamento</asp:HyperLink></div>	
