...
<div class="step">
	...
	<asp:Panel ID="pnEditing" Runat="server" Visible="False">
		...
		<DIV class="bloccoForm">Varie:<BR><ASP:TEXTBOX id="txtVarie" Runat="server" Width="500" Height="200" TextMode="MultiLine"></ASP:TEXTBOX>
		</DIV>
	...
	<asp:Panel ID="pnShow" Runat="server" Visible="False">
		<DIV class="bloccoForm">
			<span class="etichettaShow">Prima Volta:</span> <asp:Label id="lblPrimaVolta" Runat="server"></asp:Label>
		</DIV>
		<DIV class="bloccoForm">
			<span class="etichettaShow">Tipologia:</span> <asp:Label id="lblTipologia" Runat="server"></asp:Label>
		</DIV>
		<DIV class="bloccoForm">
			<span class="etichettaShow">Localizzazione:</span> <asp:Label id="lblLocalizzazione" Runat="server"></asp:Label>
		</DIV>
		<DIV class="bloccoForm">
			<span class="etichettaShow">Irradiazione:</span> <asp:Label id="lblIrradiazione" Runat="server"></asp:Label>
		</DIV>
		<DIV class="bloccoForm">
			<span class="etichettaShow">Periodo Insorgenza:</span> <asp:Label id="lblPeriodoInsorgenza" Runat="server"></asp:Label>
		</DIV>
		<DIV class="bloccoForm">
			<span class="etichettaShow">Durata: 
<asp:Label id="lblDurata" Runat="server"></asp:Label></DIV>
		<DIV class="bloccoForm">
			<span class="etichettaShow">Familiarità:</span> <asp:Label id="lblFamiliarita" Runat="server"></asp:Label>
		</DIV>
		<DIV class="bloccoForm">
			<span class="etichettaShow">Altre Terapie:</span> <asp:Label id="lblAltreTerapie" Runat="server"></asp:Label>
		</DIV>
		<DIV class="bloccoForm">
