...
<div class="step">
	...
	<asp:Panel ID="pnEditing" Runat="server" Visible="False">
		<DIV class="bloccoForm">Strutturale:<BR><ASP:TEXTBOX id="txtStrutturale" Runat="server" TextMode="MultiLine" Height="200" Width="500"></ASP:TEXTBOX>
		</DIV>
		<DIV class="bloccoForm">Cranio Sacrale:<BR><ASP:TEXTBOX id="txtCranioSacrale" Runat="server" TextMode="MultiLine" Height="200" Width="500"></ASP:TEXTBOX>
		</DIV>
		<DIV class="bloccoForm">Ak Ortodontica:<BR><ASP:TEXTBOX id="txtAkOrtodontica" Runat="server" TextMode="MultiLine" Height="200" Width="500"></ASP:TEXTBOX>
		</DIV>
