...
<div class="step">
	...
	<asp:Panel ID="pnEditing" Runat="server" Visible="False">
		<DIV class="bloccoForm">
			<SPAN class="etichetta">Data:</SPAN><ASP:TEXTBOX id="txtData" Runat="server" Width="80" MaxLength="10" ReadOnly="False"></ASP:TEXTBOX>
		</DIV>
		<DIV class="bloccoForm">
			<SPAN class="etichetta">Tipo:</SPAN><ASP:DROPDOWNLIST id="ddlTipo" Runat="server">
		...
		<DIV class="bloccoForm">Descrizione:<BR><ASP:TEXTBOX id="taDescrizione" Runat="server" Width="500" Height="200" TextMode="MultiLine"></ASP:TEXTBOX>
		</DIV>
		<DIV class="bloccoSubmit">
			<ASP:BUTTON id="cmdSalva" onclick="Salva_Dati" Runat="server" CssClass="button"></ASP:BUTTON>
		</DIV>
	...
	<asp:Panel ID="pnShow" Runat="server" Visible="False">
		<DIV class="bloccoForm">
			<SPAN class="etichettaShow">Data:</SPAN> <asp:Label id="lblData" Runat="server"></asp:Label>
		</DIV>
		<DIV class="bloccoForm">
			<SPAN class="etichettaShow">Tipo:</SPAN> <asp:Label id="lblTipo" Runat="server"></asp:Label>
		</DIV>
		<DIV class="bloccoForm">
			Descrizione:</SPAN>
			<DIV
