...
namespace Steve.App
{
	...
	/// </summary>
	public class AnamnesiProssima : System.Web.UI.Page
	{

		protected System.Web.UI.WebControls.Panel pnMenuContestuale;

		// Per recuperare il valore dallo UC
		protected UserControl.AnamnesiProssima UcAnamnesiProssima;
		delegate void Del_GestioneMenuContestuale(ArrayList arl);

		private void Page_Load(object sender, System.EventArgs e)
		{
			if(!Page.IsPostBack){
				UcAnamnesiProssima.Azione = (eAzioni)Enum.Parse( typeof(eAzioni), Request.QueryString["azione"] );
				UcAnamnesiProssima.PopolaOggettiForm();
			}

			// Gestione Delegate -----------------------------------------------------------
			Del_GestioneMenuContestuale del_GestioneMenuContestuale = new Del_GestioneMenuContestuale(this.GestioneMenuContestuale);
			this.UcAnamnesiProssima.GestioneMenuContestuale = del_GestioneMenuContestuale;
		}
