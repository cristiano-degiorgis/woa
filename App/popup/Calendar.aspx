<%@ Page language="c#" Codebehind="Calendar.aspx.cs" Trace="False" AutoEventWireup="false" Inherits="Cemit.Lib.Calendar" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
	<head>
		<title>Calendar</title>
		<meta content="http://schemas.microsoft.com/intellisense/ie5" name="vs_targetSchema">
		<link href="/steve/css/calendar.css" type="text/css" rel="stylesheet">
			...
			<table cellSpacing="0" cellPadding="0" width="100%" border="0">
				...
				<tr bgColor="white">
					<td align="middle" colSpan="2">
						...
						<asp:calendar id="Calendar1" runat="server" BorderWidth="5px" ShowTitle="False" ShowNextPrevMonth="False" BorderStyle="Solid" Font-Size="XX-Small" Font-Names="Arial" BorderColor="White" DayNameFormat="FirstTwoLetters" ForeColor="#C0C0FF" FirstDayOfWeek="Monday" CssClass="standard-text">
