<%@ Control Language="c#" AutoEventWireup="false" Codebehind="Paziente.ascx.cs" Inherits="Steve.UserControl.Paziente" TargetSchema="http://schemas.microsoft.com/intellisense/ie5"%>
