<%@ Control Language="c#" AutoEventWireup="false" Codebehind="MainMenu.ascx.cs" Inherits="Steve.UserControl.MainMenu" TargetSchema="http://schemas.microsoft.com/intellisense/ie5"%>
<div id="MainMenu">
	<div class="item">
