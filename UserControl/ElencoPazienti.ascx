<%@ Control Language="c#" AutoEventWireup="false" Codebehind="ElencoPazienti.ascx.cs" Inherits="Steve.UserControl.ElencoPazienti" TargetSchema="http://schemas.microsoft.com/intellisense/ie5"%>

<div><asp:Label ID="lblMsg" Runat="server" Visible="False"></asp:Label>
