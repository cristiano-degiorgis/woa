<%@ Control Language="c#" AutoEventWireup="false" Codebehind="Trattamento.ascx.cs" Inherits="Steve.UserControl.Trattamento" TargetSchema="http://schemas.microsoft.com/intellisense/ie5"%>
