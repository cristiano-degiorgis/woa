...
//		private Consulto	_Consulto1;
		...
		public Paziente Paziente1 {
			...
			set {  _Paziente1 = value; HttpContext.Current.Session["Paziente"] = value;}
		}
		...
		public int IdConsulto {
			...
			set {  _IdConsulto = value; HttpContext.Current.Session["IdConsulto"] = value;}
		}
...
//		}
		...
		protected override void OnInit(System.EventArgs e) {
			...
			if ( oTmp1 != null) {
				this._Paziente1 = (Paziente) oTmp1;
			}

			if ( oTmp2 != null) {
				this._IdConsulto = (int) oTmp2;
			}else
				this._IdConsulto = -1;
